...
mod tests{
    ...
    #[test]
    fn parse_headers_1(){
        let headers = fs::read_to_string("tests\\headers1.txt").expect("Should have been able to read the file");
    ...
    #[test]
    fn parse_headers_2(){
        let headers = fs::read_to_string("tests\\headers2.txt").expect("Should have been able to read the file");
        ...
        assert_eq!(result["Postman-Token"], "1f5a5c52-d86d-495c-93e4-5aaee56390ea");
    }

    #[test]
    fn parse_http_request_1(){
        let mut file =File::open("tests\\httpGetDeafultPath.txt").expect("Should have been able to read the file");
        let mut buffer: Vec<u8> = Vec::new();
        
        file.read_to_end(&mut buffer);
        let buffer_reader = BufReader::<Vec<u8>>::new(buffer);
        let result = http_parser::parse_http_request().unwrap();
