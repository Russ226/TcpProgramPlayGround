...
def test_httpRquest():
    ...
    expect_result1: HttpParser.HTTPRequest = HttpParser.HTTPRequest()
    ...
    expect_result2: HttpParser.HTTPRequest = HttpParser.HTTPRequest()
    ...
    expect_result3: HttpParser.HTTPRequest = HttpParser.HTTPRequest()
    ...
    expect_result4: HttpParser.HTTPRequest = HttpParser.HTTPRequest()
    ...
    actual_result1 = HttpParser.parseHTTPRequest(test_httpRquest_update_json_body)
    ...
    actual_result2 = HttpParser.parseHTTPRequest(test_httpRquest_multipart)
    ...
    actual_result3 = HttpParser.parseHTTPRequest(test_httpRquest_get)
    ...
    actual_result4 = HttpParser.parseHTTPRequest(test_httpRquest_delete_body)
